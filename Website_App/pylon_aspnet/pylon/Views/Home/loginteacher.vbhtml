...
<div style="width: 50%; border-radius: 15px; margin: 5% 25%;">
    <img style="margin: 10px auto 20px auto; display: block; border-radius: 10px;" src="~/img/Teacher.png" class="navbar-brand-img " width="25%" alt="main_logo">
    ...
    <form action="TeacherLogin" method="post">
        <div style="border: solid 1px white; margin-bottom: 10px; border-radius: 10px;" class="input-group input-group-outline">
            <input name="teacherID" style="padding: 10px; font-size: 20px; color: white;" placeholder="Enter ID" type="text" class="form-control">
        </div>
        <div style="border: solid 1px white; margin-bottom: 10px; border-radius: 10px;" class="input-group input-group-outline">
